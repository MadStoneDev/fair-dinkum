  ...
  return (
    <button
      className={`p-2 flex items-center justify-center gap-1 ${
        isTracking
          ? "bg-neutral-200 dark:bg-dark text-dark/50 dark:text-light/50 shadow-inner shadow-dark/20 hover:scale-[97%]"
      ...
      } rounded-xl lg:rounded-2xl font-medium transition-all duration-500 ease-in-out`}
      onClick={() => {
        action?.();
