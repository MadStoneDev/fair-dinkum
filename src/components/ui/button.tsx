...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white" +
    ...
    " dark:focus-visible:ring-neutral-300 transition-all duration-500 ease-in-out",
  {
    variants: {
      variant: {
        default:
          "bg-accent text-neutral-50 hover:opacity-80 dark:hover:opacity-80",
        destructive:
          "bg-red-700 text-neutral-50 hover:bg-red-500/90 dark:bg-red-900 dark:text-neutral-50" +
